      ...
      try {
        ...
        setPersonalInfo({
          ...
          birthdate: profileData.birthday
            ...
            : "",
          height: profileData.curr_height || "", // Changed from height to curr_height
  ...
  const handleSave = async () => {
    try {
      ...
      const profileData = {
        ...
        height: personalInfo.height, // This will be mapped to curr_height in the API
...
//             ? new Date(profileData.birthday).toISOString().split("T")[0]
//             : "",
//           curr_height: profileData.curr_height || "",
//           currentWeight: profileData.curr_weight || "",
//           goalWeight: profileData.goal_weight || "",
//         });
...
//         gender: personalInfo.gender,
//         birthday: personalInfo.birthdate,
//         curr_height: personalInfo.curr_height,
//         curr_weight: personalInfo.currentWeight,
//         goal_weight: personalInfo.goalWeight,
//         fitness_level: fitnessInfo.fitnessLevel?.toUpperCase() || "BEGINNER",
//         fitness_goals: fitnessInfo.fitnessGoals || [],
...
//                 <div className="info-item">
//                   <label>Height:</label>
//                   <span>{personalInfo.curr_height || 0} cm</span>
//                 </div>
//                 <div className="info-item">
//                   <label>Current Weight:</label>
//                   <span>{personalInfo.currentWeight || 0} kg</span>
...
//                       id="height"
//                       name="height"
//                       value={personalInfo.curr_height || ""}
//                       onChange={handlePersonalInfoChange}
//                     />
//                   </div>
//                   <div className="form-group">
